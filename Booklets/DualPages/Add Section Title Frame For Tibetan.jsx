...
var sectionTitleTibetanStyleName = "Running Header Tibetan";

var sectionTitleTibetanStyle = doc.paragraphStyles.itemByName(sectionTitleTibetanStyleName);
if (!sectionTitleTibetanStyle.isValid) {
    alert(
        "Before using this script you need to have defined the following styles:\n"+
        "- " + sectionTitleTibetanStyleName
    );
} else if (!selection) {
    ...
    addSectionTitleTextFrame("བླ་ཕུར་");
}

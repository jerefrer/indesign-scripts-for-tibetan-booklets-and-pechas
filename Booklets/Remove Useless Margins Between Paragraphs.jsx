...
function main() {
    ...
    for (var i = 0; i < allParagraphs.length; i++) {
        ...
        var nextParagraph = i < allParagraphs.length - 1 ? allParagraphs[i + 1] : null;
        ...
        if (styleMap[currentStyle] && nextParagraph && nextParagraph.appliedParagraphStyle.name === styleMap[currentStyle]) {
        ...
        for (var key in styleMap) {
            if (styleMap[key] === currentStyle && prevParagraph && prevParagraph.appliedParagraphStyle.name === key) {
